...
set(CMAKE_CXX_FLAGS "-mmcu=${MCU} -ffunction-sections -fdata-sections" CACHE STRING "C++ Flags")
set(CMAKE_CXX_LINK_FLAGS "-Wl,-gc-sections" CACHE STRING "Linker Flags")

set(CMAKE_C_FLAGS "-mmcu=${MCU} -ffunction-sections -fdata-sections" CACHE STRING "C Flags")
